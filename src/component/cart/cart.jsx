        ...
        <div className="max-w-4xl mx-auto bg-white rounded-3xl border border-gray-100 p-8 shadow-sm">
            ...
            {cartItems.length === 0 ? (
                ...
                <div className="space-y-4">
                    {cartItems.map((item) => (
                        <div key={item.id} className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-gray-100">
                    ...
                    <button className="w-full bg-[#7c3aed] text-white py-4 rounded-full font-bold text-lg mt-6 hover:bg-[#6d28d9] transition-all">
                        Proceed To Checkout
                    </button>
                </div>
            )}
